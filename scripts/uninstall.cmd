@echo off
:: ============================================
:: BioShock Infinite Head Tracking - Uninstall
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=bioshock-infinite"
set "MOD_DISPLAY_NAME=BioShock Infinite Head Tracking"
set "MOD_DLLS=xinput1_3.dll"
set "MOD_INTERNAL_NAME=BioShockInfiniteHeadTracking"
set "STATE_FILE=.headtracking-state.json"
:: BepInEx | MelonLoader | MonoCecil | ASILoader | REFramework | UE4SS | xNVSE
:: | None
set "FRAMEWORK_TYPE=None"
set "SHIM_MARKER=BioShock Infinite Head Tracking"
...
set "PRESERVE_FILES=Binaries\Win32\CameraUnlock.ini Binaries\Win32\HeadTracking.ini"
